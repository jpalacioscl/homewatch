...
if [[ "$CORAL_DETECTED" == "true" ]]; then
    ...
    FRIGATE_IMAGE_SUFFIX=""
elif [[ "$GPU_TYPE" == "nvidia" ]]; then
    FRIGATE_DETECTOR="onnx_cuda"
    FRIGATE_DETECTOR_LABEL="NVIDIA ONNX/CUDA ($GPU_MODEL)"
    FRIGATE_IMAGE_SUFFIX="-nvidia"   # imagen con soporte CUDA
...
export FRIGATE_DETECTOR FRIGATE_DETECTOR_LABEL FRIGATE_IMAGE_SUFFIX
